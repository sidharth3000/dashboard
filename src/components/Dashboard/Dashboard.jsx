...
import { MdArrowForwardIos, MdOutlineWorkOutline } from "react-icons/md";
import Jobs from "../Jobs/Jobs";
let company = [
  { id: "Tikaj.co", place: "Gurugram" },
  { id: "Veritas", place: "Banglore" },
  { id: "Tata AIG Pvt. Ltd.", place: "Pune" },
  { id: "Me n Tee", place: "Remote" },
];

let applied = [
  { com: "Push Notification", reject: true },
  { com: "Oracle", reject: false, stage: "Interview" },
  { com: "Shadi.com", reject: false, stage: "Test" },
  { com: "Tvarit", reject: false, stage: "Result" },
];
const Dashboard = () => {
          ...
          <div className={styles.dlist}>
              ...
              <div>
                ...
                <form className={styles.searchForm}>
                  ...
                  <button
                    ...
                    onClick={() => window.alert(`Search for ${value}`)}
                  >
                    <BiSearch />
                  </button>
            ...
            <Card>
              <div>
                ...
                <ul className={styles.uldlist}>
                  {company.map((e) => (
                    <li className={styles.liuldlist}>
                      <BiBuildings
                ...
                <a href="#" style={{ marginLeft: "10px", fontSize: "14px" }}>
                  More Jobs <BsArrowBarRight />
                </a>
              </div>
            </Card>
            <br />
